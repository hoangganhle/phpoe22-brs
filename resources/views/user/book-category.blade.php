...
<div class="container top">
    <h3 class="text-center mb-4">{{ trans('client.category') }} {{ trans('client.name') }}</h3>
    <div class="row">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 right">
                        ...
                        <p>{{ trans('client.votes') }}<span class="compare ml-2" href="#"><i class="bi bi-heart-beat text-danger" title="{{ trans('client.favorite') }}"></i></a></span></p>
                        <p></p>
                    </div>
                </div>
            </div>
